...
REQUEST_LIST = [
    ...
    '/cbr/key_indicators',
    '/api/asset/list',
    '/api/asset/add/USD/US stocks/120.0/0.056',
    '/api/asset/add/EUR/Eurobonds/12.0/0.012',
    '/api/asset/add/Ag/Silver/50.5/0.0101',
    '/api/asset/add/INR/Indian high-yield bonds/10.5/0.991',
    '/api/asset/add/JPY/Japanese Government Bond/1.5/0.017',
    '/api/asset/add/JPY/Japanese Government Bond/1.5/0.017',
    '/api/asset/list',
